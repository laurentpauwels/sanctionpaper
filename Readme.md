...
- `concordanceAlpha.m` produces $\alpha_r$, the fraction of Labor Compensation over Value Added in national currency, which is required to approximate the effect of sanctions. It matches the ICIO21 and WIOT16 industry lists.
